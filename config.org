...
(use-package org-roam
  :custom
  (org-roam-db-location (concat (getenv "XDG_DATA_HOME") "/emacs/roam/org-roam.db"))
  (org-roam-directory "~/w/2-areas/second-brain.org/2-areas/zettelkasten")
  (org-roam-dailies-directory "../journal/daily")
  :config
  (nkl/leader-key
    "n f"	'(org-roam-node-find			:wk "[N]ode [F]ind")
    "n i"	'(org-roam-node-insert			:wk "[N]ode [I]nsert"))
